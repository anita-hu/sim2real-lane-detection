...
class UNIT_sim2real_Trainer(nn.Module):
    """
    This class is the normal Unit Trainer but with the lane line training removed.
    """
    def __init__(self, hyperparameters):
        super(UNIT_sim2real_Trainer, self).__init__()
